...
where salary = 100000 or first_name='James';

drop index emp_sal on employees;
show indexes from employees;
create index emp_sal_f on employees(salary,first_name); # composite index 
explain select * from employees 
where salary = 100000 or first_name='James';
...
# What is the differnce between clustured index or non clustured index 